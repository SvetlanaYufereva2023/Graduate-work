...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	НаборЗаписей = РегистрыНакопления.ЗадолженностьПокупателей.СоздатьНаборЗаписей();  
	НаборЗаписей.Отбор.Регистратор.Установить(Ссылка.Основание);
	...
	Набор.Отбор.Регистратор.Установить(Ссылка.Основание);
	Набор.Прочитать(); 
	Набор.Очистить();
